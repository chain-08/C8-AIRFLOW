...
SCHEDULE_CRON = '30 3 * * 2-6'  # ✅ 8:30 PM Toronto (3:30 AM UTC Next Day)

TABLE_NAME = 'eod'
LOG_TABLE = 'eod_fetch_logs'
N_THREADS = 10
TIME_BUFFER = -5  # ✅ UTC -5 for Toronto
...
default_args = {
    'owner': 'airflow',
    'retries': 0,  # ✅ Retry handled by second task
...
with DAG(
    ...
    # ✅ Retry Task at 12:30 AM Toronto
