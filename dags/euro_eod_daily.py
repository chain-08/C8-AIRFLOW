...
SCHEDULE_CRON = '30 18 * * 1-5'  # ✅ 8:30 PM CET (6:30 PM UTC)

TABLE_NAME = 'eod'
LOG_TABLE = 'eod_fetch_logs'
N_THREADS = 10
TIME_BUFFER = 2  # ✅ UTC +2 for CET (safe for daylight savings)
...
with DAG(
    ...
    # ✅ Retry Task at 12:30 AM CET (4 hours later)
