...
SCHEDULE_CRON = '0 6 * * 1-5'  # 6 AM UTC — safe for European markets
...
with DAG(
    ...
    def fetch_and_store_eod_data():
        ...
        metadata_pl = (
            ...
            .drop_nulls()
            .unique(subset=["Code"], keep="first")  # ✅ Get first exchange & type for each code
        )
